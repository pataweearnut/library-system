...
- **DevOps**
  - Dockerfiles manifests are included, along with a GitHub Actions **CI**    workflow. CD is intentionally not wired yet and will be added once the target runtime/platform is chosen.
